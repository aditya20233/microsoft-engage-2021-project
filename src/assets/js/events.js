...
//   console.log(document.querySelector("#create-room"));
...
//     // function aadi()
//     // {
//     //   document.getElementById("share").href=`mailto:?subject='hello'&body='${roomlink}'`;
//     // }
//     // aadi();
//     // console.log("calling aadi");


//       //show message with link to room
//       document.querySelector(
//         "#room-created"
//       ).innerHTML = `Meet Succesfully Created. Start the <a href='${roomLink}'>Meet</a>.`;
